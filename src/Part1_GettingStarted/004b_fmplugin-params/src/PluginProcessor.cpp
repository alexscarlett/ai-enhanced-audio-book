...
#endif
      ,
      phase{0}, dphase{0}, frequency{440}, amp{0}, ampTarget{0}, dAmp{0.00005}, mod_phase{0}, mod_dphase{0}, mod_index{0.5}, mod_depth{100}
{
...
void TestPluginAudioProcessor::setModIndex(double newIndex)
{
    *modIndexParam = (float)newIndex;
}
void TestPluginAudioProcessor::setModDepth(double newDepth)
{
