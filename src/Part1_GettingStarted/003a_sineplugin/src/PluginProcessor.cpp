...
void TestPluginAudioProcessor::prepareToPlay(double sampleRate, int samplesPerBlock)
{
    ...
    // Since prepareToPlay is called when audio system is ready, we can get sample rate here to calulate dphase
...
{
    juce::ScopedNoDenormals noDenormals; // prevents extermely small floating point values (denormals) from causing problems
...
// Slider: listener for frequency changes in processor
